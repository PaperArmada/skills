...
- **[to-frd](./to-frd/SKILL.md)** — Turn the current conversation context into an FRD (Feature Requirements Document) and submit it as a GitHub issue.
- **[prd-interview](./prd-interview/SKILL.md)** — Interactive interview that drives you through writing a product-level PRD, written to a markdown file as the interview progresses.
